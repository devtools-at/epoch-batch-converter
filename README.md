...
<p align="center">
  <a href="https://devtools.at/tools/epoch-batch-converter"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Convert multiple timestamps</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/epoch-batch-converter">Try Online</a> •
...
**[Try Epoch Batch Converter online at DevTools.at →](https://devtools.at/tools/epoch-batch-converter)**
...
## What is Epoch Batch Converter?

Convert multiple timestamps. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/epoch-batch-converter';
